...
public class Area implements Serializable {
	...
	private Tile createTile(String tileString, Position pos) {
		...
		if (tileString.equals("n")) {
			return null;
		} else if (tileString.equals("c0") || tileString.equals("g0") || tileString.equals("h0")
				|| tileString.equals("R0")) { //FIXME: ADD More token types here to add different types of floor tiles.
