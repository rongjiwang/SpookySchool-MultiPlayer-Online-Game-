...
/**
 * This class contains all of the logic Spooky School game. This class controls game state.
...
public class SpookySchool implements Runnable{
	...
	public boolean addPlayer(String name) {
		if (this.players.size() < 4) {
			...
			return this.players.add(newPlayer); //Add the player to the list of players in the game.
		}
		return false;
	}
	...
	public boolean movePlayer(String playerName, Direction direction) {
		...
		if (!player.getDirection().equals(direction)) {
			...
			return false; //Returns false because the player hasn't "moved" location
		}
