...
public class InvButton extends JPanel implements MouseListener{
	...
	public InvButton(int row, int column, String item){
		...
		this.column = column;
		inventoryItem = item;
		highLight = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/highlight.png")).getImage();
		noHighLight = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/nohighlight.png")).getImage();
		image = noHighLight;
