...
public class MainPanel extends JPanel{
	...
	public void setIcons(){
		...
		icons[0] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/info.png"));
		icons[1] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/infohighlight.png"));
		icons[2] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/players.png"));
		icons[3] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/playershighlight.png"));
		icons[4] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/quit.png"));
		icons[5] = new ImageIcon(this.getClass().getResource("/com/school/ui/UIImages/quithighlight.png"));
	}
